...
2) Atomic operations on single document warranty data integrity that make sure if votes is created their associated counters and points will be updated and so on.
