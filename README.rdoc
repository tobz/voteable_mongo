...
Initial idea is based one http://cookbook.mongodb.org/patterns/votes/.

Voteable Mongoid is built for speed. It uses only one database request per collection to validate data validation, update data, and get updated data.
