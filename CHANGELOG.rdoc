== 0.7.3
  * Add :return_votes => true option to vote function to warranty always return votes data
  * Add Voteable.voted?, Voteable.up_voted?, Voteable.down_voted?
  * Refactor: Introduce validate_and_normalize_vote_options(options) to be reused among functions
